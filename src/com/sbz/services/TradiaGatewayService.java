...
public class TradiaGatewayService extends TradiaService{


  private String configurationFile = null;
//  private String serviceDescription = null;
  private AdapterBuilderDirector builder = null;
  public TradiaGatewayService(){
 ...
 public void setServiceStatus(boolean newServiceStatus){
  ...
  public void startService(){
    builder = new AdapterBuilderDirector(this.configurationFile);
     ...
     Adapter b = null;
     try{
       a = (Adapter)builder.createAdapter("adapter2Fix");
       a.start();
       b = (Adapter)builder.createAdapter("adapter2Gateway");
       b.start();
     }catch(Exception e){
       e.printStackTrace();
     }
